...
public:
    ...
    bool xorBitList(BitList b)
    {
        if(this->bitNum!=b.bitNum)
            return false;
        int j;
        for(j=0;j<byteNum-16;j+=16)
        {
            t1=_mm512_loadu_si512((__m512i*)(this->byteArray+j));
            t2=_mm512_loadu_si512((__m512i*)(b.byteArray+j));
            t3=_mm512_xor_si512(t1,t2);
            _mm512_storeu_si512((__m512i*)(this->byteArray+j),t3);
    ...
    void setBitList(BitList b)
    {
        ...
        for(j=0;j<byteNum-16;j+=16)
        {
            t4=_mm512_loadu_si512((__m512i*)(b.byteArray+j));
            _mm512_storeu_si512((__m512i*)(this->byteArray+j),t4);
