...
public:
    ...
    bool xorBitList(BitList b)
    {
        if(this->bitNum!=b.bitNum)
            return false;
        int j;
        for(j=0;j<byteNum-8;j+=8)
        {
            t1=_mm256_loadu_si256((__m256i*)(this->byteArray+j));
            t2=_mm256_loadu_si256((__m256i*)(b.byteArray+j));
            t3=_mm256_xor_si256(t1,t2);
            _mm256_storeu_si256((__m256i*)(this->byteArray+j),t3);
    ...
    void setBitList(BitList b)
    {
        ...
        for(j=0;j<byteNum-8;j+=8)
        {
            t4=_mm256_loadu_si256((__m256i*)(b.byteArray+j));
            _mm256_storeu_si256((__m256i*)(this->byteArray+j),t4);
